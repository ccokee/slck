"""
Django settings for slck project.
...
SECRET_KEY = 'django-insecure-r2oigwc6w)pu6u=iuz16bt7+)vd!)q)c5w#(&bn0_hmf#8pjc*'
...
WSGI_APPLICATION = 'slck.wsgi.application'
...
ASGI_APPLICATION = 'slck.routing.application'